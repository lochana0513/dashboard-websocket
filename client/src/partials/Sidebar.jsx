            ...
            <ul className="mt-3">
              ...
              <li className="mb-1 last:mb-0">
                <NavLink
                  ...
                  to="/"
                  className={({ isActive }) =>
                    "flex items-center px-3 py-2 rounded-lg transition duration-150 truncate " + 
                    (isActive 
                      ? "text-violet-500 bg-violet-50 dark:bg-violet-500/10" 
                      : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50")
                  }
                >
